...
class SupportVectorRegressor(APIView):
    """
...
class KNeighborsRegressor(APIView):
    """
    API endpoint that allows get the the result form the auto_ml.py corresponding function.
    - auto_ml.py stores all the ds related utility functions
...
class ElasticnetRegression(APIView):
    """
    API endpoint that allows get the the result form the auto_ml.py corresponding function.
    - auto_ml.py stores all the ds related utility functions
...
class GradientboostingRegression(APIView):
    """
    API endpoint that allows get the the result form the auto_ml.py corresponding function.
    - auto_ml.py stores all the ds related utility functions
...
# class CatBoostRegression(APIView):
#     permission_classes = (IsAuthenticated,)
...
class RegressionMethods(APIView):
    """
    API endpoint that allows get the the result form the auto_ml.py corresponding function.
    - auto_ml.py stores all the ds related utility functions
