...
import pandas as pd
from .auto_ml import auto_arima_model, time_series_predict
from dflux.api.serializers import DataModelMetaDataSerializer
from dflux.db.models import DataModel


class TimeSeriesPreprocessingEndpoint(APIView):
    """
...
class TimeSeriesMetaDataEndpoint(APIView):
    """
...
class TimeSeriesPredictionEndpoint(APIView):
    """
